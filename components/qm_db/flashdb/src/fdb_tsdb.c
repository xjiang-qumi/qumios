 ...
 * @param arg callback argument
 */
void fdb_tsl_iter_by_status(fdb_tsdb_t db, fdb_tsl_status_t status, fdb_tsl_cb cb, void *arg)
{
    struct tsdb_sec_info sector;
    uint32_t sec_addr, traversed_len = 0;
    struct fdb_tsl tsl;
...
/**
 * The TSDB iterator for each TSL by status.
 *
 * @param db database object
 * @param db tls status
 * @param cb callback
 * @param arg callback argument
 */
void fdb_tsl_iter_reverse_by_status(fdb_tsdb_t db, fdb_tsl_status_t status, fdb_tsl_cb cb, void *cb_arg)
{
    struct tsdb_sec_info sector;
    uint32_t sec_addr, traversed_len = 0;
    struct fdb_tsl tsl;
 ...
 * @param arg callback argument
 */
void fdb_tsl_iter_by_time_and_status(fdb_tsdb_t db, fdb_time_t from, fdb_time_t to, fdb_tsl_status_t status, fdb_tsl_cb cb, void *cb_arg)
{
    struct tsdb_sec_info sector;
    uint32_t sec_addr, start_addr, traversed_len = 0;
    struct fdb_tsl tsl;
