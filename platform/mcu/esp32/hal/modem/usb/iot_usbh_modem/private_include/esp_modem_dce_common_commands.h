...
/**
 * @brief lbs info structure used as a result to esp_modem_dce_get_lbs() API
 */
typedef struct esp_modem_dce_lbs_ctx_s {
    float longitude;             
    float latitude;            
} esp_modem_dce_lbs_ctx_t;
 ...
 * @param[in] dce     Modem DCE object
 * @param[in] param   None
 * @param[out] result esp_modem_dce_lbs_ctx_t type returning rssi and ber values
 *
 * @return esp_err_t
 *      - ESP_OK on success
 *      - ESP_FAIL on error
